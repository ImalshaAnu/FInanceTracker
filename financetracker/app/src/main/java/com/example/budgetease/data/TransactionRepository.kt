package com.example.budgetease.data

import android.content.Context
import android.content.SharedPreferences
import com.example.budgetease.model.Transaction
...
class TransactionRepository(context: Context) {
    ...
    fun getIncomeByCategory(month: Int, year: Int): Map<String, Double> {
        val income = getIncomeForMonth(month, year)
        return income.groupBy { it.category }
            .mapValues { (_, transactions) -> transactions.sumOf { it.amount } }
    }
